...
if(isset($message)){
	if($error){
		...
		echo $this->session->set_flashdata('message',"Se grabó correctamente.");
	}
}
...
fruits.splice (ind, cuant, it1, it2, … , itN)  // Modifica el array eliminando cuant elementos e insertando it1, it2, …, itN, desde el índice ind.


// ************** ARRAY EN PHP **************
Array numérico indexado: 	$variable = array($valor1, $valor2, $valor2,...);
...
mysqldump -u nombredeusuario -p nombre_basededatos > nombredelarchivo.sql  (enter) Pide contraseña.
